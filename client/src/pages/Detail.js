                ...
                <div className="container">
                    <div className="">
                        <div className="introduce">
                            <h3 className="title">Chung tay quyên góp xây trường mới tặng các em học sinh bản Sín Chải C </h3>
                            <p> Lớp học tạm bợ, xung quanh thưng gỗ, lợp mái tôn hư hỏng, nền đất lầy lội, nhưng thầy trò Sín Chải C vẫn kiên trì bám trường, bám lớp theo đuổi ước mơ tri thức. Chung tay giúp đỡ ngay!</p>
                        </div>
                        <div className="slider">
                            <Carousel autoplay>
                                <div>
                                    <img width="100%" height="400px" src="../images/donate/detail/1.jpg"></img>
                                </div>
                                <div>
                                    <img width="100%" height="400px" src="../images/donate/detail/2.jpg"></img>
                                </div>
                                <div>
                                    <img width="100%" height="400px" src="../images/donate/detail/3.jpg"></img>
                                </div>
                        ...
                        <div className="col-8">
                            <Tabs defaultActiveKey="1"/*  onChange={callback} */>
                                <TabPane tab="Câu chuyện" key="2">
                                    ...
                                    <img src="../images/donate/detail/3.jpg"></img>
                                    ...
                                    <p>
                                        <img src="../images/donate/detail/2.jpg"></img></p>
                                    <p style={{ textAlign: "center" }}>
                                        <em>
                                    ...
                                    <p>
                                        <img src="../images/donate/detail/1.jpg"></img></p>
                                    <p style={{ textAlign: "center" }}>
                                        <em>
